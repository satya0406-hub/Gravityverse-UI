...
app = FastAPI(title="GravityVerse Neural API", version="3.2.0")
...
async def chat_endpoint(request: ChatRequest):
    ...
    system_instr = request.system_instruction or request.systemInstruction or "You are GravityVerse AI assistant."
